...
public class fullHistoryOfPatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 730, 230));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
               ...
               table_history.setAutoResizeMode(table_history.AUTO_RESIZE_OFF);
               table_history.setModel(DbUtils.resultSetToTableModel(rs));
            }
                catch(Exception e){
